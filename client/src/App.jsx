...
const Navbar = ({ token, setView, handleLogout }) => (
...
function App() {
  ...
  return (
    <div className="app-root">
      <Navbar token={token} setView={setView} handleLogout={handleLogout} />
      ...
      {(view === 'login' || view === 'register') && (
        <AuthForm
          ...
          error={error} setView={setView} setError={setError}
        />
      )}
